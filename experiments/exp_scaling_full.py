#!/usr/bin/env python3
"""
Phase A: Scaling Validation - Full run with 2 seeds
"""
import os
import sys
import json
...
print("="*70)
print("PHASE A: SCALING VALIDATION (Full)")
print("="*70)
...
with open('archive/experiments/phaseA_scaling_full.json', 'w') as f:
...
print(f"\nResults saved to: archive/experiments/phaseA_scaling_full.json")
